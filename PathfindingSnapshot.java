...
public class PathfindingSnapshot {
    ...
    public List<Integer> pathTo(int dstId) {
        if (!settledIds.get(dstId)) {
            throw new IllegalArgumentException("Not a settled vertex");
        }
        //Initialize a linked list
        List<Integer> paths = new LinkedList<>();
        //Current id is the dstId
        int current = dstId;
        ...
        //Finally add the starting Id
        paths.addFirst(startId);
        return paths;
    }
